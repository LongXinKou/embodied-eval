...
@register_model("robopoint")
class RoboPoint(BaseAPIModel):
    """
    RoboPoint Model
    "https://huggingface.co/wentao-yuan/robopoint-v1-vicuna-v1.5-13b"
    """

    def __init__(
            self,
            model_name_or_path: str = "wentao-yuan/robopoint-v1-vicuna-v1.5-13b",
            ...
            conv_template: Optional[str] = "llava_v1",
            **kwargs,
    ) -> None:
        super().__init__()
        ...
        # Load model
        eval_logger.info(f"Loading RoboPoint model from {model_name_or_path}")
    ...
    def generate_until(self, requests) -> List[str]:
        ...
        progress_bar = tqdm(total=num_iters, disable=(self.rank != 0), desc="RoboPoint Responding")
