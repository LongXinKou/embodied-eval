...
@register_model("spacer")
class SpaceR(BaseAPIModel):
    """
    SpaceR Model
    "https://huggingface.co/RUBBISHLIKE/SpaceR"
    """

    def __init__(
            self,
            model_name_or_path: str = "RUBBISHLIKE/SpaceR",
        ...
        # Load model
        eval_logger.info(f"Loading Space-R   model from {model_name_or_path}")
